export const ImageCard = ({ handleInput, imgPreview, handleClick }) => {
  return (
    <div>
      <div className="card-compact card w-full gap-5 bg-base-100 shadow-2xl">
        ...
        <div className="card-body gap-5">
          ...
          <input
            type="file"
            className="file-input-bordered file-input w-full max-w-xs shadow-xl drop-shadow-xl"
            onChange={handleInput}
          />
          <div className="card-actions justify-center">
            <button
              className="btn-success btn shadow-md drop-shadow-xl"
              onClick={handleClick}
            >
              Classify
            </button>
